...
function Login(props) {
  ...
  useEffect(() => {
    let allFilled = Object.keys(formData).every((key) => formData[key]);
    allFilled ? setValidation(true) : setValidation(false);
  }, [formData]);
          ...
          <div className="registry-form">
            ...
            <div className="registry-submit">
              <div className="form-input required-field">
                ...
                >
                  <input type="text" field="account" onChange={changeHandler} />
                </div>
              </div>
              <div className="form-input required-field">
                ...
                >
                  <input field="password" onChange={changeHandler} />
                </div>
                {errorMsg ? (
                  <div className="field-error">Invalid email or password!</div>
                ) : null}
              </div>
              <div className="form-input">
                ...
                >
                  <button onClick={loginHandler} disabled={!validation}>
                    Login
                  </button>
                </div>
              </div>
